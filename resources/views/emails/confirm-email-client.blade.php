        ...
        <tbody>
            ...
            <tr>
                <td colspan="2" style="padding: 40px 40px;">
                    <h2 style="color: #0a2b3e; font-size: 24px; margin: 0 0 20px; text-align: center;">Bem-vindo, {{ $client->name }}!</h2>
                    
                    <p style="color: #555; font-size: 16px; line-height: 1.6; margin-bottom: 25px;">
                        Obrigado por se cadastrar no <strong>Cartório Central</strong>. Para completar o seu cadastro e ativar sua conta, confirme seu endereço de e-mail clicando no botão abaixo:
                    </p>
                    ...
                    <p style="color: #888; font-size: 14px; line-height: 1.6;">
                        ...
                        Sua conta será deativada automaticamente se não for confirmada em 24 horas.
                    </p>
